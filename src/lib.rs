...
// Re-export key model types for convenience when using this crate as a
// library. This avoids deep module paths in dependent crates.
pub use models::{
    breath_signature::BreathSignature,
